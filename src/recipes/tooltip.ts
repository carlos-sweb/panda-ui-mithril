...
// Real daisyUI tail shape: a soft curved wedge (not a rotated square), masked
...
export const tooltipStyles = cva({
  ...
  variants: {
    ...
    color: {
      neutral: { '--tt-bg': 'var(--colors-neutral)', '&[data-tip]:before': { color: 'var(--colors-neutral-content)' } },
      primary: { '--tt-bg': 'var(--colors-primary)', '&[data-tip]:before': { color: 'var(--colors-primary-content)' } },
      secondary: { '--tt-bg': 'var(--colors-secondary)', '&[data-tip]:before': { color: 'var(--colors-secondary-content)' } },
      accent: { '--tt-bg': 'var(--colors-accent)', '&[data-tip]:before': { color: 'var(--colors-accent-content)' } },
      info: { '--tt-bg': 'var(--colors-info)', '&[data-tip]:before': { color: 'var(--colors-info-content)' } },
      success: { '--tt-bg': 'var(--colors-success)', '&[data-tip]:before': { color: 'var(--colors-success-content)' } },
      warning: { '--tt-bg': 'var(--colors-warning)', '&[data-tip]:before': { color: 'var(--colors-warning-content)' } },
      error: { '--tt-bg': 'var(--colors-error)', '&[data-tip]:before': { color: 'var(--colors-error-content)' } },
    },
  },
  defaultVariants: {
    position: 'top',
