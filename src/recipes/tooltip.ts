...
export const tooltipRecipe = defineRecipe({
  ...
  variants: {
    ...
    color: {
      neutral: { '--tt-bg': 'token(colors.neutral)', '&[data-tip]:before': { color: 'neutral-content' } },
      primary: { '--tt-bg': 'token(colors.primary)', '&[data-tip]:before': { color: 'primary-content' } },
      secondary: { '--tt-bg': 'token(colors.secondary)', '&[data-tip]:before': { color: 'secondary-content' } },
      accent: { '--tt-bg': 'token(colors.accent)', '&[data-tip]:before': { color: 'accent-content' } },
      info: { '--tt-bg': 'token(colors.info)', '&[data-tip]:before': { color: 'info-content' } },
      success: { '--tt-bg': 'token(colors.success)', '&[data-tip]:before': { color: 'success-content' } },
      warning: { '--tt-bg': 'token(colors.warning)', '&[data-tip]:before': { color: 'warning-content' } },
      error: { '--tt-bg': 'token(colors.error)', '&[data-tip]:before': { color: 'error-content' } },
    },
  },
  defaultVariants: {
    position: 'top',
