...
export const checkboxStyles = cva({
  ...
  variants: {
    color: {
      neutral: { color: 'token(colors.neutral-content)', '--input-color': 'token(colors.neutral)' },
      primary: { color: 'token(colors.primary-content)', '--input-color': 'token(colors.primary)' },
      secondary: { color: 'token(colors.secondary-content)', '--input-color': 'token(colors.secondary)' },
      accent: { color: 'token(colors.accent-content)', '--input-color': 'token(colors.accent)' },
      info: { color: 'token(colors.info-content)', '--input-color': 'token(colors.info)' },
      success: { color: 'token(colors.success-content)', '--input-color': 'token(colors.success)' },
      warning: { color: 'token(colors.warning-content)', '--input-color': 'token(colors.warning)' },
      error: { color: 'token(colors.error-content)', '--input-color': 'token(colors.error)' },
    },
    size: {
