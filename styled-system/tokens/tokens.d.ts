/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `letterSpacings.${LetterSpacingToken}` | `fontSizes.${FontSizeToken}` | `shadows.${ShadowToken}` | `blurs.${BlurToken}` | `sizes.${SizeToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `radii.${RadiusToken}` | `fonts.${FontToken}` | `spacing.${SpacingToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "white" | "black" | "base-100" | "base-200" | "base-300" | "base-content" | "primary" | "primary-content" | "secondary" | "secondary-content" | "accent" | "accent-content" | "neutral-content" | "info" | "info-content" | "success" | "success-content" | "warning" | "warning-content" | "error" | "error-content"
